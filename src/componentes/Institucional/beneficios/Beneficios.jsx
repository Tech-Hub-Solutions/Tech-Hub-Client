      ...
      <section className="section__beneficios">
        <div className="content__beneficios">
          <div className="beneficios__text">
            ...
            <p>
              Avalie habilidades e competências com confiança antes de tomar uma
              decisão. Enxergue além das palavras e conheça o potencial real.
            </p>
            <div className="text__titulo-beneficio">
            ...
            <p>
              Tome decisões informadas e simplifique a seleção. Compare
              habilidades técnicas e socioemocionais para escolher o candidato
              ideal.
            </p>
            <div className="text__titulo-beneficio">
            ...
            <p>
              Comunique-se com transparência por meio do nosso chat online.
              Alinhe expectativas e detalhes essenciais do projeto de forma
              clara e direta.
            </p>
            <ButtonExplorarTalentos
              className="beneficios__text-button"
