      ...
      try {
        resizeImage(arquivo, (blob) => {
          ...
          reader.onloadend = () => {
            ...
            arquivoDetail.file = new File([blob], arquivo.name, {
              type: arquivo.type,
            });
                ...
                <MenuList autoFocusItem={open} onKeyDown={handleListKeyDown}>
                  <MenuItem sx={{ padding: "0px", color: "transparent" }}>
                    <Button
                      ...
                      startIcon={
                        <img style={{ width: "25px" }} src={ImageImg} />
                      }
                    >
                      <p style={{ color: "black" }}>Imagem</p>
                      <VisuallyHiddenInput
                        type="file"
                        onChange={(e) => selecionarAnexo(e, "imagem")}
                      />
                    </Button>
                  </MenuItem>
                  <MenuItem sx={{ padding: "0px", color: "transparent" }}>
                    <Button
                      ...
                      startIcon={
                        <img style={{ width: "25px" }} src={DocumentImg} />
                      }
                    >
                      <p style={{ color: "black" }}>Arquivos</p>
                      <VisuallyHiddenInput
                        type="file"
                        onChange={(e) => selecionarAnexo(e, "documento")}
                      />
                    </Button>
                  </MenuItem>
                </MenuList>
